...
CREATE TABLE IF NOT EXISTS users (
  ...
  phone                VARCHAR(20)   NOT NULL  DEFAULT '' COMMENT 'PH format, e.g. 09171234567 — used for 2FA & delivery updates',
  street_address       VARCHAR(300)  NOT NULL  DEFAULT '' COMMENT 'Default shipping: street / barangay',
  unit                 VARCHAR(100)  NOT NULL  DEFAULT '' COMMENT 'Apt / Suite / Unit / Floor',
  city                 VARCHAR(100)  NOT NULL  DEFAULT '',
  state                VARCHAR(100)  NOT NULL  DEFAULT '' COMMENT 'Province / Region',
